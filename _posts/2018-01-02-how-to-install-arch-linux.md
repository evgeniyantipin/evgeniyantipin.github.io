...
To check your current existing drives run `fdisk -l`. Find a name of the drive you want to install your system to in the list and remember it (something like */dev/sda*).
